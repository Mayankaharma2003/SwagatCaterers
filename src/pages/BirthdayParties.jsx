...
import { 
  FaBirthdayCake, FaUtensils, FaUsers, FaCamera, 
...
const BirthdayParties = () => {
  const packages = [
    {
      ...
      description: 'Complete birthday celebration package with all essentials',
      features: [
        '8 Types of Starters',
    ...
    },
    {
      ...
      price: 'Starting from ₹499 per plate',
      description: 'Perfect package for intimate birthday celebrations',
      features: [
        '6 Types of Starters',
        '8 Main Course Items',
        '4 Types of Desserts',
  ...
  const features = [
    {
      icon: FaUtensils,
      title: 'Theme Food Stations',
      description: 'Interactive and fun food corners for all age groups'
    },
    {
      icon: FaWineGlassAlt,
      title: 'Mocktail Bar',
      description: 'Variety of refreshing non-alcoholic beverages'
    },
    {
      icon: FaLeaf,
      title: 'Kids Special Menu',
      description: 'Special menu items curated for children'
    },
    {
      icon: FaMagic,
      title: 'Theme Setup',
      description: 'Customized decor matching your party theme'
    }
  ];

  const specialities = [
    {
      title: 'Theme Based Setup',
      description: 'Customized decor and food presentation based on party theme'
    },
    {
      title: 'Special Birthday Cake',
      description: 'Custom designed cake with your choice of flavors'
    },
    {
      title: 'Kids Corner',
      description: 'Dedicated space with kid-friendly food options'
    },
    {
      title: 'Live Counters',
    ...
    },
    {
      ...
      description: 'Fun activities and games setup for entertainment'
    },
    {
      title: 'Photo Booth',
      description: 'Themed photo booth with props for memories'
    }
  ];
    ...
    <>
      ...
      <section className="relative h-[60vh] overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: 'url(/images/services/birthday-hero.jpg)' }}
        />
          ...
          <div className="flex flex-col justify-center h-full">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-display text-theme-light mb-6">
                Make Your Birthday 
                <span className="text-theme-accent"> Magical</span>
              </h1>
              <p className="text-xl text-theme-light/90 mb-8">
                Create unforgettable birthday celebrations with our specialized catering services
              </p>
            ...
            {packages.map((pkg, index) => (
              ...
              >
                <div className="flex items-center gap-4 mb-6">
                  <FaBirthdayCake className="text-4xl text-theme-accent" />
                  <div>
      ...
      <section className="py-24 bg-theme-light relative overflow-hidden">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              Let's create a magical celebration for your special day
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
